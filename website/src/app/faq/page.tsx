                ...
                <div id="FaqSection2" className={s.Section2}>
                    ...
                    <div className={`card ${s.card}`} onClick={() => setOrToggleActive(1)}>
                        <div className={s.dropdown}>
                            <p className={`${s.question} ${isActive(1) ? s.active : ''}`}>Dla kogo są instalacje i jaki jest zakres mocy [50 kWe-{'>'}500 kWe+]?</p>
                    ...
                    <div className={`card ${s.card}`} onClick={() => setOrToggleActive(2)}>
                        <div className={s.dropdown}>
                            <p className={`${s.question} ${isActive(2) ? s.active : ''}`}>Jakie są typowe substraty i jak je dobrać?</p>
                    ...
                    <div className={`card ${s.card}`} onClick={() => setOrToggleActive(3)}>
                        <div className={s.dropdown}>
                            <p className={`${s.question} ${isActive(3) ? s.active : ''}`}>Czy 50 kWe można skalować modułowo?</p>
                    ...
                    <div className={`card ${s.card}`} onClick={() => setOrToggleActive(4)}>
                        <div className={s.dropdown}>
                            <p className={`${s.question} ${isActive(4) ? s.active : ''}`}>Co oznacza realizacja "pod klucz"?</p>
                    ...
                    <div className={`card ${s.card}`} onClick={() => setOrToggleActive(5)}>
                        <div className={s.dropdown}>
                            <p className={`${s.question} ${isActive(5) ? s.active : ''}`}>Jaki jest typowy harmonogram i czas realizacji?</p>
                    ...
                    <div className={`card ${s.card}`} onClick={() => setOrToggleActive(6)}>
                        <div className={s.dropdown}>
                            <p className={`${s.question} ${isActive(6) ? s.active : ''}`}>Jak działa serwis i monitoring?</p>
                    ...
                    <div className={`card ${s.card}`} onClick={() => setOrToggleActive(7)}>
                        <div className={s.dropdown}>
                            <p className={`${s.question} ${isActive(7) ? s.active : ''}`}>Czy pomagacie w finansowaniu i dokumentach?</p>
                    ...
                    <div className={`card ${s.card}`} onClick={() => setOrToggleActive(8)}>
                        <div className={s.dropdown}>
                            <p className={`${s.question} ${isActive(8) ? s.active : ''}`}>Z czego składa się "technologia" w praktyce?</p>
