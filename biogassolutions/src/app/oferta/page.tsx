        ...
        <>
            <div className="content">
                ...
                <div className="main-content">
                    <div id="Section2">
                        <ul id="offer">
                            <li id="mikrobiogazownie" className="offer-item">
                                <h2>Mikrobiogazownie</h2>
                                <h3>Małej mocy</h3>

                                <div className="grid-wrapper">
                                    <div className="miniature card" style={{gridArea: 'miniature'}}>
                                        <div className="icon-container"><img src="/img/icons/biogas.png" alt="Ikona mikrobiogazowni" className="icon" /></div>
                                    </div>

                                    <div className="for-whom card" style={{gridArea: 'for-whom'}}>
                                        <h4>Dla kogo?</h4>
                                        <ul>
                                    ...
                                    <div className="benefits card" style={{gridArea: 'benefits'}}>
                                        <h4>Zalety</h4>
                                        <ul>
                                    ...
                                    <div className="power card" style={{gridArea: 'power'}}>
                                        <span className="counter"><span className="num">{'<'}50</span>kW</span>
                                    </div>
                                </div>
                            </li>

                            <li id="biogazownie" className="offer-item">
                                <h2>Biogazownie</h2>
                                <h3>Średniej i dużej mocy</h3>
                                ...
                                <div className="grid-wrapper">
                                    ...
                                    <div className="power card" style={{gridArea: 'power'}}>
                                        <span className="counter"><span className="num">{'<'}500</span>kW lub <span className="num">{'>'}500</span>kW</span>
                                    </div>
                                </div>
                            </li>

                            <li id="biometanownie" className="offer-item">
                                <h2>Biometanownie</h2>
                                <h3>Upgrading do biometanu</h3>
                            ...
                            <li id="doradztwo-i-analizy" className="offer-item">
                                <h2>Doradztwo i analizy</h2>
                            ...
                            <li id="serwis-i-eksploatacja" className="offer-item">
                                <h2>Serwis, eksploatacja i monitoring instalacji</h2>
                            ...
                            <li id="analyzes-audites" className="offer-item">
                                <h2>Analizy i audyty</h2>
                                <h3>techniczno-technologiczne</h3>
