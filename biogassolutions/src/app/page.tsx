...
function Home() {
    return (
        <section className="content">
            <section className={`cover ${styles.section1}`} id="HomeSection1">
            ...
            <section className="main-content">
                <section className={styles.section2} id="HomeSection2">
                    <h2>Co robimy?</h2>
                ...
                <section className={styles.section3} id="HomeSection3">
                    <h2>Dlaczego my?</h2>
                    <div className={`grid-wrapper ${styles['grid-wrapper']}`}>
                        ...
                        <div className={`card ${styles.card}`}>
                            <img className={styles.icon} src="/img/icons/technology.png" alt="Ikona technologii" />
                        ...
                        <div className={`card ${styles.card}`}>
                            <img className={styles.icon} src="/img/icons/24-hours-service.png" alt="Ikona obsługa 24/7" />
                            <p>Zdalny monitoring 24/7, szkolenia operatorów i standard reakcji serwisu do 48 h z opcją skrócenia wg umowy.</p>
                        </div>
                        <div className={`card ${styles.card}`}>
                            <img className={styles.icon} src="/img/icons/shield.png" alt="Ikona tarczy" />
                ...
                <section className={styles.section4} id="HomeSection4">
                    <h2>Proces inwestycyjny</h2>
                    <img className={styles.timeline} src="/img/timeline.png" alt="Przebieg procesu inwestycyjnego - oś czasu" />
                </section>

                <section className={styles.section5} id="HomeSection5">
                    <h2>Finansowanie</h2>
                    <p>Przygotowujemy dokumentację i wnioski oraz wspieramy rozliczenia w programach krajowych i unijnych.</p>

                    <div className={styles.grants}>
                        <img className={styles.grantLogo} src="/img/grants/feng-logo.png"            alt="Fundusze Europejskie dla Nowoczesnej Gospodarki"/>
                        <img className={styles.grantLogo} src="/img/grants/nfosigw-logo.png"         alt="Narodowy Fundusz Ochrony Środowiska i Gospodarki Wodnej" />
                        <img className={styles.grantLogo} src="/img/grants/energia-dla-wsi-logo.png" alt="Energia Dla Wsi" />
                    </div>
